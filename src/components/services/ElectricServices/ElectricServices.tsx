...
const electricalServices = [
  {
    ...
    descripcion:
      "Cuadros eléctricos generales completos con autómatas para alumbrados, regulación de sistemas de calefacción, climatización y agua caliente sanitaria",
  },
  {
    titulo: "Led",
  ...
  },
  {
    ...
    descripcion:
      "Corrección de gastos por energía reactiva en facturas eléctricas.",
  },
];
        ...
        <div className="container grid items-center gap-6 text-center md:text-left">
          <div className="grid items-center gap-2">
            ...
            <h2 className="text-3xl font-bold tracking-tight">
              Instalaciones electricas y optimicaciones
            </h2>
          </div>
          <p className="mx-auto max-w-3xl text-gray-500 md:text-left">
            Especialistas en instalaciones eléctricas y reparaciones de todo
            tipo en empresas, comunidades de propietarios, administradores e
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 items-center gap-6">
            {electricalServices.map((service) => (
              <Card key={service.titulo}>
                <CardContent
                  key={service.titulo}
                  className="flex-col flex p-3 gap-[6px] text-sm h-48"
                >
